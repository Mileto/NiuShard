...
namespace Joeku.MOTD
{
	public class MOTD_Gump : Gump
	{
		...
		public MOTD_Gump( Mobile user, bool help, int index ) : base(150, 150) //la posizione iniziale
        {
			...
			AddPage(0);
            AddBackground(0, 0, 450, 400, 0xA28);  //AddBackground(x,y,width,height,gumpID)
		...
		{	
			if( !this.Help )
				AddButton(390, 15, 22153, 22155, 1, GumpButtonType.Reply, 0); // Button - Main - Help
			    //AddButton(420, 15, 22150, 22152, 0, GumpButtonType.Reply, 0); // Button - Main - Close
